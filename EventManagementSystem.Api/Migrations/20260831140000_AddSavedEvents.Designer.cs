...
namespace EventManagementSystem.Api.Migrations
{
    ...
    [Migration("20260831140000_AddSavedEvents")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventManagementSystem.Api.Models.TeamMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("EventManagementSystem.Api.Models.User", b =>
                {
                    ...
                    b.Property<string>("IdentificationNumberLast4")
                        .HasMaxLength(10)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("EventManagementSystem.Api.Models.TeamMember", b =>
                {
                    b.HasOne("EventManagementSystem.Api.Models.User", "Organizer")
                        .WithMany()
                        .HasForeignKey("OrganizerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
